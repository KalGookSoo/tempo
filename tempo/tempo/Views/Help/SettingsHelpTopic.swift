    ...
    static let topics: [SettingsHelpTopic] = [
        SettingsHelpTopic(
            ...
            paragraphs: [
                ...
                "시작하면 입력이 잠기고 설정한 모드로 실행됩니다. 실행 중에는 일시정지·재개·리셋이 가능하고, 종료되면 사운드·진동으로 알려줍니다. 카운트다운 모드는 시스템 알림도 함께 옵니다.",
            ]
        ),
        SettingsHelpTopic(
            id: "stopwatch",
        ...
        SettingsHelpTopic(
            ...
            paragraphs: [
                "Tabata, FGB, EMOM 같은 기본 프리셋은 목록에서 바로 실행할 수 있습니다.",
                "새 프리셋을 만들려면 이름과 인터벌 세트·라운드를 설정하고 저장하면 목록에 추가됩니다. 알림 큐는 프리셋마다 따로 정하지 않고, 설정 탭의 전역 기본값을 그대로 사용합니다.",
                "기본 프리셋도 내 프리셋과 마찬가지로 이름 변경·편집·삭제가 자유롭고, 복제해서 별도 프리셋으로 만들 수도 있습니다.",
            ]
        ),
        SettingsHelpTopic(
            ...
            paragraphs: [
                "알림 방식은 없음/사운드/진동/사운드+진동 중에서 고르고, 시작 전 알림 시점(없음·3·5·10초)도 설정할 수 있습니다.",
                "준비·운동 시작·휴식 시작·구간 종료·운동 종료·라운드 종료·전체 종료 같은 이벤트마다 알림 방식을 따로 지정할 수 있습니다.",
                "기본 제공 사운드 외에 설정 > 녹음한 사운드에서 직접 녹음한 음성도 알림 큐로 쓸 수 있습니다.",
                "애플워치를 착용 중이면 아이폰의 알림이 애플워치로 대신 전달될 수 있습니다(iOS의 알림 미러링 기능). 아이폰에서만 받고 싶다면 아이폰의 Watch 앱 > 알림 > tempo에서 설정을 바꿀 수 있습니다.",
            ]
        ),
        SettingsHelpTopic(
            ...
            paragraphs: [
                ...
                "아이패드는 세로·가로 화면을 모두 지원하고(아이폰은 세로 고정), 미러링 중에도 기기에서 시작·일시정지·재개·리셋을 그대로 조작할 수 있습니다.",
            ]
        ),
    ]
